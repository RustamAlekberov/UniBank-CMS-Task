...
public class Accounts {
    ...
    private List<ArchPayments> fromAccIdList;

    @OneToMany(mappedBy = "toAccId", fetch = FetchType.LAZY)
    private List<ArchPayments> toAccIdList;
    ...
    @XmlTransient
    public List<ArchPayments> getFromAccIdList() {
        return fromAccIdList;
    }

    public void setFromAccIdList(List<ArchPayments> fromAccIdList) {
        this.fromAccIdList = fromAccIdList;
    }
    @XmlTransient
    public List<ArchPayments> getToAccIdList() {
        return toAccIdList;
    }

    public void setToAccIdList(List<ArchPayments> toAccIdList) {
